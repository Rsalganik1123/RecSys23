...
def process_mpd(output_file, prev_songs_window):
    ...
    data = pickle.load(open('/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/datasets/small_100_10/CF_trainval.pkl', "rb")) #contig_2
    test = pickle.load(open('/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/datasets/small_100_10/CF_test.pkl', "rb"))
    ...
    pickle.dump(item_embeddings, open('/home/mila/r/rebecca.salganik/scratch/PinSAGE_experiments/benchmarks/CF_track_embeddings.pkl', "wb"))
    print("saved track embeddings to: {}".format('PinSAGE_experiments/benchmarks/CF_track_embeddings.pkl'))
...
if __name__ == '__main__':
    b = time.time()
    # playlists_file = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/OG_CSV/spotify_million_playlist_dataset/data'
    # target_playlists = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/OG_CSV/spotify_million_playlist_dataset/test_data/spotify_million_playlist_dataset_challenge/challenge_set.json'
    output_file = '/home/mila/r/rebecca.salganik/scratch/PinSAGE_experiments/benchmarks/small_100_10_CF_recs.pkl'
