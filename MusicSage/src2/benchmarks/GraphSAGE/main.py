...
def get_emb(epoch, p): 
        ...
        # p = '/home/mila/r/rebecca.salganik/scratch/PinSAGE_experiments/benchmarks/GS/small_100_10_run/'
        #Build graph 
        g, reverse_eids, train_eids, val_eids = build()
...
def make_recs(epoch, p):
        ...
        k = 500 
        #Data paths
        train_path = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/datasets/small_100_10/train_val.pkl'
        test_path = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/datasets/small_100_10/test.pkl'
