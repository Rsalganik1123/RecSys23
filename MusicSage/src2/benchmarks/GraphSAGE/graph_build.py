...
def build(): 
    print("loading data")
    # path = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/final_pieces/complete_data_final_3way_with_emb_and_pos_contig.pkl'
    path = '/home/mila/r/rebecca.salganik/scratch/MusicSAGE_Data/datasets/small_100_10/train_val.pkl'
