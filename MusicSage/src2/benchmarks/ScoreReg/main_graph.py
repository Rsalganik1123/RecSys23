...
def make_recs_OG(cfg, model_path, output_path, data_path, model_name, rec_num, track_path = None, c = None, mode='test'): 
    ...
    if model_name == 'MACR':
        ...
        ui_scores = user_emb@item_emb.T - c * user_ego@item_ego.T
        print(f'saving to {track_path}')
        pickle.dump(item_ego, open(track_path, "wb"))
    else: 
